...
set_4 = set_countries | set_countries2 #union
set_6 = set_countries & set_countries2 #intersection
set_8 = set_countries - set_countries2 #difference
set_10 = set_countries ^ set_countries2 #symmetric_difference
'''
#------------------------------------------------
'''
import random
